...
namespace PrintPlanet\Sylius\ServiceProvider\AddressingServiceProvider;

use Silex\Application;
use Silex\ServiceProviderInterface;
use Webmozart\Assert\Assert;

final class SyliusAddressingServiceProvider implements ServiceProviderInterface
{
    /**
    ...
    {
        return 'PrintPlanet\Sylius\Component\Addressing\Model';
    }
}
