...
namespace PrintPlanet\Sylius\ServiceProvider\AttributeServiceProvider;

use Silex\Application;
use Silex\ServiceProviderInterface;

final class SyliusAttributeServiceProvider implements ServiceProviderInterface
{
    /**
    ...
    {
        return 'PrintPlanet\Sylius\Component\Attribute\Model';
    }
