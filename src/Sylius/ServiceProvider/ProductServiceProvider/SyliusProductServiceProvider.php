...
namespace PrintPlanet\Sylius\ServiceProvider\ProductServiceProvider;

use Silex\Application;
use Silex\ServiceProviderInterface;

final class SyliusProductServiceProvider implements ServiceProviderInterface
{
    /**
    ...
    {
        return 'PrintPlanet\Sylius\Component\Product\Model';
    }
